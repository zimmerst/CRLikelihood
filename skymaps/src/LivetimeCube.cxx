/** @file LivetimeCube.cxx
   ...
   $Header: /nfs/slac/g/glast/ground/cvs/skymaps/src/LivetimeCube.cxx,v 1.16 2011/05/30 03:05:58 heather Exp $
...
double LivetimeCube::value(const astro::SkyDir& dir, double costh, double phi)
{
    ...
    if( phi<0)   return bins(dir)[costh]/sqrt(1-costh);
    return bins(dir)(costh,phi)/sqrt(1-costh);
}
