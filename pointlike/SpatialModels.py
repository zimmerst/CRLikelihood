"""A set of classes to implement spatial models.
   ...
   $Header: /usr/local/CVS/SLAC/ScienceTools-scons/pointlike/python/uw/like/SpatialModels.py,v 1.113 2014/07/15 02:16:17 mdwood Exp $
...
try:
    ...
    from pyLikelihood import SkyDir, SkyImage

#!FIXME!
from skymaps import PySkySpectrum,PySkyFunction,Hep3Vector,SkyDir, \
        SkyIntegrator,CompositeSkyFunction,PythonUtilities,SkyImage

from dsphs.pointlike.utilities.quantile import Quantile
from dsphs.pointlike.utilities.rotations import anti_rotate_equator
from dsphs.pointlike.utilities import path
